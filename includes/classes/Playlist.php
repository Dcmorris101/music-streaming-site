<?php
  class Playlist {
    ...
    public static function getPlaylistsDropdown($con, $username) { //have to pass in cone because this doesn't have access to the construct since this is public static
